...
const contacts = [{ type: "email", detail: "alus410@proton.me" }];
  ...
  return (
    <div className="body">
      ...
      <div className="main flex flex-col justify-start gap-4 lg:h-screen">
        ...
        <h3 className="text-3xl opacity-30">
          If you have any project or need help. Get in touch
        </h3>
        <div className="flex flex-col gap-4">
          {contacts.map((c) => (
            <ContactDetail key={c.type} type={c.type} detail={c.detail} />
          ))}
        </div>
