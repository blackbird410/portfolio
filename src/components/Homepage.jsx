...
function Service({ icon, title, services }) {
  return (
    <>
      ...
      <ul>
        {services.map((s) => (
          <li key={s} className="ml-4 font-mono">
            {s}
          </li>
        ))}
      </ul>
...
export function getLinks(page) {
  let currLinks = [];
  links.forEach((l) => currLinks.push({ ...l, isSelected: l.title === page }));
      ...
      <div className="main flex flex-col justify-center items-start gap-8 lg:h-screen">
        <div className="flex flex-col gap-y-3 items-start">
          ...
          <div className="text-xl">
            Computer Science student at NDHU, aspiring SWE and Full Stack Developer.
          </div>
          <a
            href={Resume}
        ...
        <div className="flex flex-col gap-3">
          ...
          <span className="text-2xl font-thin">
            Service Provided For My Clients.
          </span>
